...
public class TransformerUtil {
    ...
    /**
     * Get the Custom Stax Source to DOM result transformer that has been
     * written to get over the JDK transformer bugs (JDK6) as well as the issue
     * of Xalan installing its Transformer (which does not support stax).
     *
     * @return
     * @throws ConfigurationException
     */
